...
studies_dump["study_id"] = studies_dump["id"].apply(petljakapi.translate.idtostring, prefix = "MPP")
...
for study_index, study_row in studies_dump.iterrows():
    ...
    samp_tbl["sample_id"] = samp_tbl["id"].apply(petljakapi.translate.idtostring, prefix = "MPS")
    ...
    for sample_index, sample_row in samp_tbl.iterrows():
        ...
        analyses_tbl["analysis_id"] = analyses_tbl["id"].apply(petljakapi.translate.idtostring, prefix = "MPA")
        ...
        run_tbl["run_id"] = run_tbl["id"].apply(petljakapi.translate.idtostring, prefix = "MPR") 
