...
def collate_output_fastqs(wildcards):
    ...
    return expand(out_path + "/{i}_1.fq",
...
rule ADD_EXTERNAL_RUNS:
    ...
    run:
        for i in input:
            ...
            petljakapi.update(db = "petljakdb_devel", table = "analyses", filters = {"id":analysis_id}, update_col = "analysis_dir", update_val = copypath)